  ...
  return (
    <div className="wrap" style={{ maxWidth: 700 }}>
      ...
      <div className="profile-card">
        ...
        <p><strong>Support Email:</strong> <a href="mailto:officialhector365@gmail.com" style={{ color: '#8C6224' }}>officialhector365@gmail.com</a></p>
        <p><strong>Support Phone:</strong> <a href="tel:+918959992195" style={{ color: '#8C6224' }}>+91 89599 92195</a></p>
