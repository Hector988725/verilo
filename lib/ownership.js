...
// Returns { [listing_id]: token } for every listing this browser has ever
// added/verified — used by the "Manage My Listing" flow to skip straight to
// a person's own listings instead of always sending them to WhatsApp support.
